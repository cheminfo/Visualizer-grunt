define(['require', 'modules/default/defaultview', 'libs/plot/plot', 'src/util/jcampconverter', 'src/util/datatraversing', 'src/util/api', 'src/util/util'], function(require, Default, Graph, JcampConverter, DataTraversing, API, Util) {
