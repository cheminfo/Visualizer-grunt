define(['modules/default/defaultview', 'libs/plot/plot', 'src/util/datatraversing', './gcms', 'src/util/util', 'src/util/api'], function(Default, Graph, Traversing, gcms, Util, API) {
